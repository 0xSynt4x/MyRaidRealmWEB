...
import variableUpdateFormatTemplate from './variable-update-format.txt?raw';
import variableUpdateRulesTemplate from './variable-update-rules.txt?raw';

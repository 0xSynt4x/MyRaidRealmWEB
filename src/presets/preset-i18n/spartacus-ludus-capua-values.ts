const valueTranslations: Record<string, string> = {
  ...
  每月15日是卡普阿竞技场例行大赛日: 'The 15th of each month is the regular tournament day at the Capua arena.',
  ...
  在竞技会名额与赞助竞逐中多次正面冲突: 'Repeated direct clashes over arena slots and sponsorship competition',
  ...
  任何威胁其家族地位与竞技场声望的行为: 'Any action that threatens his family status or arena reputation',
  ...
  '罗马贵族风短袍与披肩，佩戴家族纹章戒指': 'Roman noble-style tunic and mantle, wearing a family crest ring',
  ...
  凭借角斗士经营逐步跻身卡普阿上层社交圈: 'Gradually entered Capua high society through gladiator management',
  ...
  在卡普阿建立起稳固的赞助与赛事关系网: 'Built a stable network of patronage and arena connections in Capua',
  元老院议员: 'Senator',
  ...
  通过债务重组救活并控制过多家产业: 'Revived and controlled multiple businesses through debt restructuring',
  ...
  '体格健壮，适合训练为剑盾角斗士(Murmillo)':
    'Strong physique, suitable for training as a Murmillo sword-and-shield gladiator',
